const SPECIES = {
  ...
  seastar: {
    ...
    image:"assets/chocochip-seastar.jpg",
  ...
  horseshoe: {
    ...
    image:"assets/horseshoe-crab.jpg",
  ...
  moon: {
    ...
    image:"assets/moon-jellyfish.jpg",
  ...
  ducky: {
    ...
    image:"assets/amber-ducky-isopod.jpg",
  ...
  candy: {
    ...
    image:"assets/strawberry-candy-pill-millipede.jpg",
  ...
  tetra: {
    name:"Amber Tetra",
    scientific:"Species identification to be confirmed",
    group:"Freshwater fish · Paludarium",
    image:"assets/amber-tetra.jpg",
    imageAlt:"Real-life amber tetra",
    nameStory:"“Amber tetra” is a common or display name rather than enough information to establish a scientific species by itself. Confirm the supplier's scientific name before publishing a species-level identification.",
    quick:[["Habitat","Freshwater"],["Role","Aquatic community member"],["Food","Small aquatic foods"],["Exhibit","Paludarium"]],
    wow:"A paludarium combines land and water in one living exhibit, allowing guests to see how the two parts of an ecosystem interact.",
    characteristics:"Small schooling freshwater fish are often most comfortable when they have cover, stable water conditions and companions of their own kind. Use your confirmed species ID for precise traits.",
    behaviour:"Schooling fish may move together, investigate cover and respond quickly to movement around the habitat.",
    ecology:"Fish are part of aquatic food webs and contribute to nutrient cycling. In a paludarium, their waste and uneaten food also become part of the nutrient flow that must be managed.",
    feeding:"Use the confirmed species' dietary profile to describe feeding accurately. Keep guest information general and avoid publishing husbandry quantities.",
    mating:"Many small freshwater tetras are egg scatterers, but reproduction should be described only after the exact species is confirmed.",
    lifecycle:"Egg → larva → free-swimming juvenile → adult (general fish pattern; species-specific details vary).",
    tags:["freshwater","schooling","paludarium","ecosystem"],
    animation:"tetra"
  },
  frog: {
    ...
    image:"assets/white-tree-frog.jpg",
  ...
  skink: {
    ...
    image:"assets/crocodile-skink.jpg",
...
const EXHIBITS = {
  ...
  "paludarium":{
    ...
    intro:"A paludarium is a living enclosure that combines aquatic and terrestrial habitats. It lets us show guests how water, plants, animals, substrate and microorganisms can interact as one connected miniature ecosystem.",
    species:["tetra"]
  },
  "forest-amphibians":{
